...
.data
    input byte "JPUESZSBAPANNHTXRTLBVLL"    ; Do not change this line
    key byte "ABCXYZ"			    ; Do not change this line
...
.code
    main proc
        ...
        En:
            call Encrypt
            jmp MOVEON                      ; There is no need use jump but just in case. 
